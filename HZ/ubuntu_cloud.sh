...
# cd /tmp && yum install wget -y && wget https://github.com/munishgaurav5/ks/raw/master/HZ/ubuntu_cloud.sh && chmod 777 ubuntu_cloud.sh && ./ubuntu_cloud.sh 
...
export KSURL="https://raw.githubusercontent.com/munishgaurav5/ks/master/HZ/ubuntu.cfg"
