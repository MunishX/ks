...
export KSURL="https://raw.githubusercontent.com/munishgaurav5/ks/master/HZ/custom_rhel_centos_rocky.cfg"
...
menuentry "reinstall" {
    ...
    linux /vmlinuz inst.repo=$MIRROR inst.ks=hd:${boot_hd}:/boot/${KSFName} inst.lang=en_US inst.keymap=us inst.vnc 
