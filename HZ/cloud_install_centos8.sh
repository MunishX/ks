...
# cd /tmp && yum install wget -y && wget https://github.com/munishgaurav5/ks/raw/master/HZ/cloud_install_centos8.sh && chmod 777 cloud_install_centos8.sh && ./cloud_install_centos8.sh 
...
export KSURL="https://raw.githubusercontent.com/munishgaurav5/ks/master/HZ/cloud_centos8.cfg"
