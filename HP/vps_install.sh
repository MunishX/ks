...
# cd /tmp && wget https://github.com/munishgaurav5/ks/raw/master/HP/vps_install.sh && chmod 777 vps_install.sh && ./vps_install.sh 
...
export KSURL="https://github.com/munishgaurav5/ks/raw/master/HP/vps.cfg"
export DNS1=8.8.8.8
export DNS2=8.8.4.4
