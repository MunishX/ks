...
# cd /tmp && wget https://github.com/munishgaurav5/ks/raw/master/HP/4disk_raid0_dedibox_install.sh && chmod 777 4disk_raid0_dedibox_install.sh && ./4disk_raid0_dedibox_install.sh 
...
export KSURL="https://github.com/munishgaurav5/ks/raw/master/HP/4disk_raid0_dedibox.cfg"
export DNS1=8.8.8.8
export DNS2=8.8.4.4
